...
exports.activate_email = function (user_name, email, acitvate_link) {
	...
	* {
	        ...
	        <tr>
	          <td>
	            ...
	            <table class="btn-primary" cellpadding="0" cellspacing="0" border="0">
	              <tr>
	                <td>
	                  <a href="`+ CONFIG.host + `/confirm?email=` + email + `&active_link=` + acitvate_link + `">Verify Your express-mvc-generator</a>
	                </td>
	              </tr>
	            </table>
	            <!-- /button -->
	            ...
	            <p><a href="`+ CONFIG.host + `">express-mvc-generator Team</a></p>
	          </td>
	        </tr>
	      </table>
	      </div>
	    ...
	    <td class="container">
	      ...
	      <div class="content">
	        <table>
	          <tr>
	            <td align="center">
	              <p>Don't like these annoying emails? <a href="`+ CONFIG.host + `/unsubscribe?email=` + email + `"><unsubscribe>Unsubscribe</unsubscribe></a>.
	              </p>
	            </td>
	          </tr>
	        </table>
    ...
    var mailOptions = {
        from: '"' + CONFIG.smtp_from_name + '" <' + CONFIG.smtp_from_eamil + '>', // sender address
